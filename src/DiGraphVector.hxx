...
void write(ostream& a, const DiGraphVector<V, E>& x, bool all=false) {
...
template <class V, class E>
void print(const DiGraphVector<V, E>& x, bool all=false) { write(cout, x, all); }

template <class V, class E>
void println(const DiGraphVector<V, E>& x, bool all=false) { print(x, all); cout << "\n"; }
